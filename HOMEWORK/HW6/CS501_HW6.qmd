...
print("adjusted R^2 score:", model_size.score(x, df['average_sat_math']))
...
It's harder to tell here, but it doesn't look uniform.
...
These points don't closesly follow the line, so they're probably not normally distributed.
